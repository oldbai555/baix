...
func NewTLVDecoder() iface.IDecoder {
	return &TLVDecoder{}
}

func (tlv *TLVDecoder) GetLengthField() *iface.LengthField {
	// +---------------+---------------+---------------+
	// |    Tag        |     Length    |     Value     |
...
func (tlv *TLVDecoder) Intercept(chain iface.IChain) iface.IcResp {

	//1. Get the IMessage of BaiX
