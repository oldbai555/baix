...
const (
	// BaiX standard packing and unpacking method (baix 标准封包和拆包方式)
	BaiXDataPack string = "baix_pack_tlv_big_endian"
...
const (
	// BaiX default standard message protocol format(BaiX 默认标准报文协议格式)
	BaiXMessage string = "baix_message"
)
